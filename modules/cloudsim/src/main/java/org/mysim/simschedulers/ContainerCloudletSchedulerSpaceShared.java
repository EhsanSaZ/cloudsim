package org.mysim.simschedulers;
...
//TODO EHSAN: it is maybe ok but it must be checked again ...
public class ContainerCloudletSchedulerSpaceShared extends ContainerCloudletScheduler {
    protected int currentCpus;

    protected int usedPes;

    public ContainerCloudletSchedulerSpaceShared() {
        super();
        usedPes = 0;
        currentCpus = 0;
    }
