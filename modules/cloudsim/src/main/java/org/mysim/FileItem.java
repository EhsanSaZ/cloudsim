...
public class FileItem {
    ...
    private Parameters.FileType type;
    ...
    public void setType(Parameters.FileType type) {
        this.type = type;
    }
    ...
    public Parameters.FileType getType() {
        return this.type;
    }
    ...
    public boolean isRealInputFile(List<FileItem> list) {
        if (this.getType() == Parameters.FileType.INPUT)//input file
        {
            for (FileItem another : list) {
                if (another.getName().equals(this.getName())
                         ...
                         */
                        && another.getType() == Parameters.FileType.OUTPUT) {
                    return false;
                }
            }
            return true;
