...
public class MyThirdPlanningAlgorithm extends PlanningAlgorithmStrategy{
    ...
    public MyThirdPlanningAlgorithm(){
            ...
            if (index != -1){
                ...
                if (AllVm.size() > 0){
                    ...
                    if (provisionedVm != null){
                        ...
                        // because actual cloudlet length in Res for execution is length per PE
...
//        List <Container> non_affordableContainers= new ArrayList<>();
//        for (Container container: allRunningContainers){
//            if(isContainerAffordable(task, container)){
//                affordableContainers.add(container);
//                continue;
//            }
//            non_affordableContainers.add(container);
//        }
//
//        if (affordableContainers.size() > 0){
//            List<Container> affordableContainers_withInputData = new ArrayList<>(getContainersWithInputData(affordableContainers, task));
//            List<Container> affordableContainer_NoInputData = new ArrayList<>(affordableContainers);
//            affordableContainer_NoInputData.removeAll(affordableContainers_withInputData);
//            if (affordableContainers_withInputData.size() >0){
//                // TODO calculate BI factor and use this
//            }
//        }else{
//
//        }
